!function() {
    ...
    inssa_korea_shopping.perform = function(doc, lang) {
        inssa_korea_shopping.lang = lang;
        ...
        // anchor 
        inssa_korea_shopping.cids = fnMobileAnchor($content);
        ...
        html +=     '<img alt="" class="inssa_level" src="' + label_image.get(category, inssa_korea_shopping.lang, type) + '"></img>';
        html +=     '<div>';
